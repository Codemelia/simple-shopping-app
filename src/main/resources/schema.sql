...
CREATE TABLE cart_items (
    ...
    added_at   TIMESTAMP DEFAULT CURRENT_TIMESTAMP,                                -- LocalDateTime
...
CREATE TABLE purchase_orders (
    ...
    notes            VARCHAR(300),
    order_status     VARCHAR(20)   NOT NULL DEFAULT 'PENDING',  -- Enum as String
    order_date       TIMESTAMP	   DEFAULT CURRENT_TIMESTAMP,             -- LocalDateTime
