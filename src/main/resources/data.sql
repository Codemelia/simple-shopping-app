...
-- ── Categories ───────────────────────────────────────────────────────────────
-- reset id counter before insert
...
INSERT INTO categories (category_name, category_description) VALUES
  ...
  ('Hiking Shoes', 'Hiking shoes for all terrains');
...
-- String productName, String productDescription, String brand, String imageUrl, Double price,
-- Double discountPercent, Integer stockQuantity, Boolean active, Category category
INSERT INTO products (
	product_name, product_description, brand, image_url, price, 
	discount_percent, stock_quantity, active, category_id) VALUES
(
  'Gyuto Pro 210mm',
...
INSERT INTO users (
	...
	first_name, last_name, birth_date, active
) VALUES
  ('john_doe', 'password123', 'john@example.com', 'John', 'Doe', '1990-05-14', TRUE),
  ('jane_smith', 'secret456', 'jane@example.com', 'Jane', 'Smith', '1985-11-30', TRUE),
  ('admin', 'admin', 'admin@choppee.com', 'Admin', 'Choppee','1980-01-01', TRUE);
...
-- Cart cart, Product product, Integer quantity
INSERT INTO cart_items (cart_id, product_id, quantity) VALUES
  (1, 1, 1),   -- Gyuto Pro
  (1, 9, 2);   -- 2× Cut-Resistant Gloves
...
-- Double totalAmount, String shippingAddress, String notes, OrderStatus orderStatus,
-- LocalDateTime orderDate, LocalDateTime deliveredAt, User user
INSERT INTO purchase_orders (
	total_amount, shipping_address, notes, order_status, 
	order_date, delivered_at, user_id
) VALUES
  (414.99,
...
-- PurchaseOrder order, Product product, Integer quantity, Double unitPrice
